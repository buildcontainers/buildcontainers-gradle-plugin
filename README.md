# Buildcontainers [![Build Status](https://travis-ci.com/buildcontainers/buildcontainers-gradle-plugin.svg?branch=master)](https://travis-ci.org/buildcontainers/buildcontainers-gradle-plugin)
